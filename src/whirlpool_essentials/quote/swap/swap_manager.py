...
from ...static_client.accounts import TickArray, Whirlpool
from ...static_client.types import Tick
...
class TickArraySequence:
    def __init__(
        self,
        keyed_tick_arrays: List[PublicKeyWithTickArray],
...
class SwapQuoteParams:
    ...
    direction: SwapDirection
    specified_amount: SpecifiedAmount
    tick_array_0: PublicKeyWithTickArray
    tick_array_1: PublicKeyWithTickArray
    tick_array_2: PublicKeyWithTickArray
